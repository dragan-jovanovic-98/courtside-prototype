...
import { StatusBadge, SMetricCard, SPageHeader, SToolbar, SSearchInput, SFilterPill, STabBar, SDateRangePicker, statusColors } from "@/components/shared";
...
import AIDashboardView from "@/components/views/ai-dashboard-view";
